// src/config/subjects/prompts/physical-health-education.ts
...
function buildTopicList(): string {
  return Object.entries(PHYSICAL_HEALTH_EDUCATION_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const PHYSICAL_HEALTH_EDUCATION_PROMPT = `You are extracting ALL questions from a JAMB Physical and Health Education past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(PHYSICAL_HEALTH_EDUCATION_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

PHE papers are mostly standalone MCQs. Groups are rare.
