// src/config/subjects/prompts/yoruba.ts
...
function buildTopicList(): string {
  return Object.entries(YORUBA_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const YORUBA_PROMPT = `You are extracting ALL questions from a JAMB Yoruba past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(YORUBA_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Yoruba papers often include comprehension passages. Use type: "comprehension" and copy the full passage text exactly.
