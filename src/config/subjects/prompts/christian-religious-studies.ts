// src/config/subjects/prompts/christian-religious-studies.ts
...
function buildTopicList(): string {
  return Object.entries(CHRISTIAN_RELIGIOUS_STUDIES_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const CHRISTIAN_RELIGIOUS_STUDIES_PROMPT = `You are extracting ALL questions from a JAMB Christian Religious Studies past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(CHRISTIAN_RELIGIOUS_STUDIES_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

CRS papers are mostly standalone MCQs. Groups are rare.
