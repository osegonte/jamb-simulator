// src/config/subjects/prompts/home-economics.ts
...
function buildTopicList(): string {
  return Object.entries(HOME_ECONOMICS_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const HOME_ECONOMICS_PROMPT = `You are extracting ALL questions from a JAMB Home Economics past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(HOME_ECONOMICS_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Home Economics papers are mostly standalone MCQs. Groups are rare.
