// src/config/subjects/prompts/french.ts
...
function buildTopicList(): string {
  return Object.entries(FRENCH_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const FRENCH_PROMPT = `You are extracting ALL questions from a JAMB French past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(FRENCH_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

French papers often include comprehension passages. Use type: "comprehension" for grouped questions and copy the full passage text.
