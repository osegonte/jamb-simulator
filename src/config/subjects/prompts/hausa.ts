// src/config/subjects/prompts/hausa.ts
...
function buildTopicList(): string {
  return Object.entries(HAUSA_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const HAUSA_PROMPT = `You are extracting ALL questions from a JAMB Hausa past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(HAUSA_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Hausa papers often include comprehension passages. Use type: "comprehension" and copy the full passage text exactly.
