// src/config/subjects/prompts/islamic-studies.ts
...
function buildTopicList(): string {
  return Object.entries(ISLAMIC_STUDIES_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const ISLAMIC_STUDIES_PROMPT = `You are extracting ALL questions from a JAMB Islamic Studies past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(ISLAMIC_STUDIES_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Islamic Studies papers are mostly standalone MCQs. Groups are rare.
