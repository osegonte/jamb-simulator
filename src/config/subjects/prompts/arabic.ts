// src/config/subjects/prompts/arabic.ts
...
function buildTopicList(): string {
  return Object.entries(ARABIC_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const ARABIC_PROMPT = `You are extracting ALL questions from a JAMB Arabic past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(ARABIC_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Arabic papers often include comprehension passages. Use type: "comprehension" for grouped questions and copy the full passage text.
