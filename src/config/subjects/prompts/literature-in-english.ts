// src/config/subjects/prompts/literature-in-english.ts
...
function buildTopicList(): string {
  return Object.entries(LITERATURE_IN_ENGLISH_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const LITERATURE_IN_ENGLISH_PROMPT = `You are extracting ALL questions from a JAMB Literature in English past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(LITERATURE_IN_ENGLISH_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Literature papers often have comprehension passages followed by questions — use type: "comprehension" for these groups. Copy the full passage text exactly.
