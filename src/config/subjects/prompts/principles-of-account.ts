// src/config/subjects/prompts/principles-of-account.ts
...
function buildTopicList(): string {
  return Object.entries(PRINCIPLES_OF_ACCOUNT_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const PRINCIPLES_OF_ACCOUNT_PROMPT = `You are extracting ALL questions from a JAMB Principles of Accounts past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(PRINCIPLES_OF_ACCOUNT_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Accounts papers are mostly standalone MCQs. Groups occur when multiple questions refer to the same financial statement or table.
