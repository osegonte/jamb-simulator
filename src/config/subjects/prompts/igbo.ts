// src/config/subjects/prompts/igbo.ts
...
function buildTopicList(): string {
  return Object.entries(IGBO_CONFIG.topics).map(([topic, data]) => {
    const subs = Array.isArray(data) ? data : (data as { subtopics: readonly string[] }).subtopics
    return `  ${topic} → ${subs.join(' | ')}`
  }).join('\n')
}

export const IGBO_PROMPT = `You are extracting ALL questions from a JAMB Igbo past paper PDF.
Return ONLY raw JSON — no markdown, no code fences, no commentary before or after the JSON.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PAPER STRUCTURE — ${(IGBO_CONFIG as any).totalQuestions || 60} QUESTIONS TOTAL
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Igbo papers often include comprehension passages. Use type: "comprehension" and copy the full passage text exactly.
